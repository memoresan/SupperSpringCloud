package util.hbase.coprocessor;
 
import com.google.protobuf.RpcCallback;
import com.google.protobuf.RpcController;
import com.google.protobuf.Service;
import entity.java.Sum;
...
public class SumEndPoint extends Sum.SumService implements Coprocessor, CoprocessorService {
    ...
    public void getSum(RpcController controller, Sum.SumRequest request, RpcCallback<Sum.SumResponse> done) {
        ...
        try {
            ...
            ResponseConverter.setControllerException((org.apache.hadoop.hbase.shaded.com.google.protobuf.RpcController) controller, ioe);
        } finally {
            if (scanner != null) {
                try {
                    scanner.close();
