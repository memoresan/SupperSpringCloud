...
public abstract class LogProvider
{
     ...
     * @return 日志提供器
     */
    public static LogProvider getInstance(Class<?> className) throws  ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        if (instance == null)
        {
